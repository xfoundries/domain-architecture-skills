...
| `using-jfoundry`             | [jfoundry](https://github.com/xfoundries/jfoundry) 专用 Java 业务项目指导，覆盖感知实际版本的依赖选择、包结构、注解、Repository/Port 边界、持久化适配器、应用事务边界、可选分布式锁、Outbox/Inbox 和 ArchUnit 规则。 |
